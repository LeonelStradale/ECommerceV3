...
class FamilySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($families as $familyName => $familyData) {
            $family = Family::create([
                'name' => $familyName,
                'icon' => $familyData['icon'] ?? null,
            ]);

            foreach ($familyData as $categoryName => $categoryData) {
                if (is_array($categoryData)) {
                    ...
                    foreach ($categoryData as $subcategoryName) {
